...
if __name__=='__main__':
    ...
    plt.plot(l_nature[:,0],l_nature[:,1],label='nature')
    plt.plot(l_d0[:,0],l_d0[:,1],'--',label='direct=(0,1)')
    plt.plot(l_d1[:,0],l_d1[:,1],'-*',label='direct=(1,1)',markevery=5)
    plt.plot(l_d2[:,0],l_d2[:,1],'-o',label='direct=(1,1)',markevery=5)
    plt.scatter(waypoints[:,0],waypoints[:,1],color = '#ff0000',s=80)
    plt.legend()
    plt.show()
